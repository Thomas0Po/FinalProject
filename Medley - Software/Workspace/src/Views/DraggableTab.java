...
//        bPane.setCenter(markerStack);
//        bPane.getCenter().getStyleClass().add("rootBorderCenter");

        Scene newScene = new Scene(markerStack);
		newScene.getStylesheets().add("Views/Medley.css"); 

        markerStage.setScene(newScene);
    ...
    public DraggableTab(String text) {
        ...
        Scene newScene = new Scene(dragStagePane);
		newScene.getStylesheets().add("Views/Medley.css"); 
        dragStage.setScene(newScene);
        ...
        nameLabel.setOnMouseReleased(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent t) {
                ...
                if(!t.isStillSincePress()) {
                    ...
                    TabPane newtab = viewRef.test(DraggableTab.this, t.getSceneX(), t.getSceneY());
                    System.out.println("COUCOU J'AI UN TABPANE !");
                    if (newtab != null){
                    	System.out.println("NEWTAB DIFFERENT DE NULL");
                    	tabPanes.add(newtab);
                    	getTabPane().getTabs().remove(DraggableTab.this);
                    	newtab.getTabs().add(DraggableTab.this);
                    	...
                    	System.out.println("NEWTAB EST NULL");
                    
                    InsertData insertData = getInsertData(screenPoint);
                    if(insertData != null) {
                    	System.out.println("INSERTDATA DIF DE NULL");
                        int addIndex = insertData.getIndex();
                        if(oldTabPane == insertData.getInsertPane() && oldTabPane.getTabs().size() == 1) {
                        	System.out.println("JE RETURN LA");
                            return;
                        }
                        ...
                        viewRef.unsplit();
                        System.out.println("CA RETURN !");
                        return;
                    }
                    if(!detachable) {
                    	System.out.println("PAS DETACHABLE");
                        return;
                    }
                    ...
                    System.out.println("FINAL STAGE");
                    	...
                    	pane.setOnDragOver(new EventHandler<DragEvent>() {
							...
							public void handle(DragEvent event) {
								System.out.println("pane on dragover");
                    	...
                    	pane.setOnDragDropped(new EventHandler<DragEvent>() {
							...
							public void handle(DragEvent arg0) {
								System.out.println("pane on drag ddropped");
							 DraggableTab.this.viewRef.tabPaneOnDragDropped(arg0, pane);
                    	...
                    	pane.getTabs().addListener(new ListChangeListener<Tab>() {
                    		...
                    		public void onChanged(ListChangeListener.Change<? extends Tab> change) {
                    			if(pane.getTabs().isEmpty()) {
                    				System.out.println("newstage hide !");
                    				newStage.hide();
                    			}
                    		}
                    	});
                    	...
                    	p.setCenter(pane);
                    	p.getCenter().getStyleClass().add("rootBorderCenter");
                    	Scene newScene = new Scene(p, 600, 500);
	...
	public void setViewRef(WorkspaceView viewRef) {
